...
// - Note:
// - If we create a custom hook which contain others states then, when we use our custom hook in multiple components, each components will receive its own state.(Only the logic of the hook is shared with the other components and not states.)
