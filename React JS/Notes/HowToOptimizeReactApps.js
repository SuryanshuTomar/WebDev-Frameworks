...
// - useMemo() basically allows you to memoize, it means to store, any kind of data which you want to store just like useCallback does it for functions. And here we could memoize the result of this sorting here simply by calling useMemo.
// - useMemo, as a first argument, wants a function. However, this is not a function that will be memoized. Instead, that function should return what you want to store.
// - And just like useCallback, useMemo wants a second argument which is an array of dependencies, basically to ensure that this stored value is updated whenever one of the values you're using in there changes.
